...
class StateStore(Protocol):
    ...
    # Private capability used by CompletionAuthority for paired terminal
    # Work/Run commits.  Ordinary callers must not use terminal status writes.
    def terminal_completion(self) -> Any: ...
